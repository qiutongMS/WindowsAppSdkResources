...
namespace winrt::cpp_winui_packaged::implementation
{
    ...
    {
        MainPage();
        static cpp_winui_packaged::MainPage Current() { return current; }
        static Windows::Foundation::Collections::IVector<cpp_winui_packaged::Scenario> Scenarios() { return scenariosInner; }
    ...
    private:
        ...
        static cpp_winui_packaged::MainPage current;
    };
}
