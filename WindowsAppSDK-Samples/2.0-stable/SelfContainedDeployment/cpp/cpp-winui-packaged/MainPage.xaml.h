...
namespace winrt::SelfContainedDeployment::implementation
{
    ...
    {
        MainPage();
        static SelfContainedDeployment::MainPage Current() { return current; }
        static Windows::Foundation::Collections::IVector<SelfContainedDeployment::Scenario> Scenarios() { return scenariosInner; }
    ...
    private:
        ...
        static SelfContainedDeployment::MainPage current;
    };
}
