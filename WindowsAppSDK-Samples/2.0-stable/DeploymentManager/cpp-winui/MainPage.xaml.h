...
namespace winrt::DeploymentManagerSample::implementation
{
    ...
    {
        MainPage();
        static DeploymentManagerSample::MainPage Current() { return current; }
        static Windows::Foundation::Collections::IVector<DeploymentManagerSample::Scenario> Scenarios() { return scenariosInner; }
    ...
    private:
        ...
        static DeploymentManagerSample::MainPage current;
    };
}
